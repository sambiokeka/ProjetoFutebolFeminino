...
def save_events(events):
    ...
    for e in events:
        ...
        partida_data = {
            "idEvent": e.get("idEvent"), "idAPIfootball": e.get("idAPIfootball"), "idLeague": e.get("idLeague"),
            "strEvent": e.get("strEvent"), "strEventAlternate": e.get("strEventAlternate"), "strFilename": e.get("strFilename"),
            "strDescriptionEN": e.get("strDescriptionEN"), "strSeason": e.get("strSeason"), "intRound": e.get("intRound"),
            "strGroup": e.get("strGroup"), "idHomeTeam": e.get("idHomeTeam"), "strHomeTeam": e.get("strHomeTeam"),
            "strHomeTeamBadge": e.get("strHomeTeamBadge"), "idAwayTeam": e.get("idAwayTeam"), "strAwayTeam": e.get("strAwayTeam"),
            "strAwayTeamBadge": e.get("strAwayTeamBadge"), "intHomeScore": e.get("intHomeScore"), "intAwayScore": e.get("intAwayScore"),
            "strResult": e.get("strResult"), "intScore": e.get("intScore"), "intScoreVotes": e.get("intScoreVotes"),
            "strTimestamp": e.get("strTimestamp"), "dateEvent": e.get("dateEvent"), "dateEventLocal": e.get("dateEventLocal"),
            "strTime": e.get("strTime"), "strTimeLocal": e.get("strTimeLocal"), "idVenue": e.get("idVenue"),
            "strVenue": e.get("strVenue"), "strCountry": e.get("strCountry"), "strCity": e.get("strCity"),
            "strMap": e.get("strMap"), "strOfficial": e.get("strOfficial"), "intSpectators": e.get("intSpectators"),
            "strPoster": e.get("strPoster"), "strSquare": e.get("strSquare"), "strFanart": e.get("strFanart"),
            "strThumb": e.get("strThumb"), "strBanner": e.get("strBanner"), "strVideo": e.get("strVideo"),
            "strTweet1": e.get("strTweet1"), "strTweet2": e.get("strTweet2"), "strTweet3": e.get("strTweet3"),
            "strPostponed": e.get("strPostponed"), "strLocked": e.get("strLocked"),
            "status_calculado": status_calculado
        }

        # A única alteração foi nesta linha. Mudei :filename para :strFilename
        sql_command = """
